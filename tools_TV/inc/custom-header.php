 ...
 *
 * @uses tutv_header_style()
 */
function tutv_custom_header_setup() {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'tutv_custom_header_args', array(
		'default-text-color'     => $default_text_color,
		'width'                  => 954,
		'height'                 => 1300,
		'wp-head-callback'       => 'tutv_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'tutv_custom_header_setup' );
...
if ( ! function_exists( 'tutv_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @since Twenty Fifteen 1.0
 *
 * @see tutv_custom_header_setup()
 */
function tutv_header_style() {
 ...
 */
function tutv_header_background_color_css() {
	$color_scheme            = tutv_get_color_scheme();
...
add_action( 'wp_enqueue_scripts', 'tutv_header_background_color_css', 11 );
 ...
 * @since Twenty Fifteen 1.0
 */
function tutv_sidebar_text_color_css() {
	$color_scheme       = tutv_get_color_scheme();
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = tutv_hex2rgb( $sidebar_link_color );
...
add_action( 'wp_enqueue_scripts', 'tutv_sidebar_text_color_css', 11 );
